...
const ManageProblem = () => {
  const [problems, setProblems] = useState([
    { id: 1, title: "Problem 1", description: "Description of Problem 1", difficulty: "Easy", tags: "Array, Sorting", is_public: true },
    { id: 2, title: "Problem 2", description: "Description of Problem 2", difficulty: "Medium", tags: "Linked List, Recursion", is_public: false },
    { id: 3, title: "Problem 3", description: "Description of Problem 3", difficulty: "Hard", tags: "Dynamic Programming", is_public: true },
  ...
  return (
    <div className="container mx-auto py-8">
      ...
      {/* Problem Add Form */}
     {/* Problem Add Form */}
<div className="mb-8 grid grid-cols-1 md:grid-cols-2 gap-x-4">
  <div>
    ...
    <form onSubmit={handleSubmit} className="max-w-lg">
      ...
      <div className="mb-4">
        ...
        <input type="text" id="difficulty" value={difficulty} onChange={(e) => setDifficulty(e.target.value)} className="w-full border border-gray-300 rounded-md px-3 py-2" />
      </div>
      {/* Tags */}
      <div className="mb-4">
      ...
      {/* Is Public */}
      <div className="mb-4">
        <label htmlFor="isPublic" className="block text-gray-700 font-bold mb-2">Is Public</label>
  ...
  <div>
    ...
    <div className="mb-4">
      ...
      <textarea id="description" value={description} onChange={(e) => setDescription(e.target.value)} className="w-full border border-gray-300 rounded-md px-3 py-2 h-40 resize-none"></textarea>
    </div>
  </div>
</div>
...
<table className="min-w-full divide-y divide-gray-200">
  <thead className="bg-gray-50">
    <tr>
      ...
      <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Public</th>
  ...
  <tbody className="bg-white divide-y divide-gray-200">
    {problems.map((problem) => (
      <tr key={problem.id}>
        ...
        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{problem.tags}</td>
        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{problem.is_public ? 'Yes' : 'No'}</td>
